...
/**
 * Servlet implementation class sendMessage done by Jialin Cao, later revise by Jialin Cao and Bin Lin
 */
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	    	 ...
	    	 DBRemoteRequests sendMessage = (DBRemoteRequests)Naming.lookup(url);
		 		...
		 		if ((rid == null) | (sid == null) | (auth == null) | (msg == null)| (iv == null)  ){
	    	 ...
	    	 String availableContactsJSONString = sendMessage.sendMessage(iv, sid, rid, msg, auth);
