...
/**
 * done by Li Jie Ye, later revise by Jialin Cao and Bin Lin
 */
public interface DBRemoteRequests extends java.rmi.Remote  {
	...
	String sendMessage(String iv, String from,String to, String message, String auth)throws RemoteException;
